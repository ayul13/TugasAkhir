...
<div class="table-responsive">
    <form action="simpan_barang.php" method="POST">
        <div class="col-6">
        <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="formlabel">Kode Barang</label>
                <input type="text" name="kode_barang" class="form-control"
                placeholder="Kode Barang">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="formlabel">Nama barang</label>
                <input type="text" name="nama" class="form-control"
                placeholder="Nama barang">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="formlabel">Harga Barang</label>
